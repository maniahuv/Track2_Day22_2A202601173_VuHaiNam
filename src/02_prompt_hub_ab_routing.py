...
PROMPT_V1_NAME = "vuhainam-rag-prompt-v1"
PROMPT_V2_NAME = "vuhainam-rag-prompt-v2"
...
SYSTEM_V1 = (
    ...
    "Trả lời ngắn gọn, tự nhiên, tối đa 2-4 câu. "
    "Nếu không tìm thấy thông tin trong context, hãy nói thẳng là bạn không biết.\n\n"
    "Context:\n{context}"
)
...
SYSTEM_V2 = (
    "Bạn là chuyên gia phân tích thông tin. Khi trả lời, hãy thực hiện theo cấu trúc: "
    "1) Tóm tắt câu trả lời chính, "
    "2) Trích dẫn dữ kiện cụ thể lấy từ context, "
    "3) Nêu rõ mức độ chắc chắn của câu trả lời (cao / trung bình / thấp). "
    "Luôn dựa trên dữ liệu trong context, không suy đoán thêm. Viết 3-5 câu, rõ ràng, có tổ chức.\n\n"
    "Context:\n{context}"
)
...
def push_prompts_to_hub(client: Client):
    ...
    try:
        url = client.push_prompt(PROMPT_V2_NAME, object=PROMPT_V2, description="V2 – chuyên gia, có cấu trúc")
